...
if awesome.startup_errors then
    naughty.notify({ preset = naughty.config.presets.critical,
                     title = "Hoppsan, nu har du gjort nåt galet med konfen igen!",
...
-- inte så förtjust i en meny uppe i vänstra hörnet så den går bort                        
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "x", function () awful.spawn("/home/nomad/bin/lock") end, 
              {description = "lock screen", group = "awesome"}),
    awful.key({ "Mod1"            }, "Return", function () awful.spawn("google-chrome --profile-directory='Profile 1'") end,
              {description = "google-chrome for fast2", group = "launcher"}),
    awful.key({ "Mod1", "Shift"   }, "Return", function () awful.spawn("google-chrome --profile-directory='Default'") end,
              {description = "google-chrome for personal use", group = "launcher"}),
    ...
    -- Print Screen and save to screenshot-folder
    awful.key({}, "Print", function () awful.spawn("scrot '/home/nomad/Pictures/Screenshots/%Y-%m-%d-%H-%M-%S_$wx$h.jpg'") end),
